  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 flex justify-center px-4 pt-4 sm:pt-6">
      ...
      >
        ...
        {/* Language Switcher - US / EN style */}
        <div className="relative z-10 flex items-center gap-1 text-sm">
          <span className="text-muted-foreground font-medium">US</span>
        ...
        <a
          href="#contact"
          className="relative z-10 px-5 sm:px-6 py-2.5 bg-primary text-primary-foreground rounded-full text-sm font-bold hover:shadow-[0_0_20px_rgba(255,184,0,0.4)] transition-all duration-300 active:scale-95 inline-flex items-center gap-2"
        >
          Get Started
